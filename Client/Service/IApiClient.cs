...
public interface IApiClient
{
    ...
    Task<ApiResponse<Boolean>> HasScheduleAsync(Int32 programId, DateTime date);
    ...
    Task<ApiResponse<Boolean>> AddFavoritesAsync(Int32 channelId, Int32 userId);
    Task<ApiResponse<Boolean>> DeleteFavoritesAsync(Int32 channelId, Int32 userId);
    Task<ApiResponse<Int32>> GetUserAsync(String login, String password_hash);
    Task<ApiResponse<Int32>> AddUserAsync(String login, String password_hash);
