...
class MockApiClient : IApiClient
{
    ...
    async public Task<ApiResponse<List<ChannelResponse>>> GetChannelsByQueryAsync(String query)
    {
        ...
        [
            ...
            new (3, "НТВ", 4, "Общероссийский телеканал, вещающий с 1993 года. Его сигнал также распространяется на страны СНГ, Балтии и другие государства через канал «НТВ Мир».", "https://static.wikia.nocookie.net/tvpedia/images/1/1a/NTV_logo_2003.svg/revision/latest?cb=20220403101423&path-prefix=ru", "развлекательный"),
    ...
    async public Task<ApiResponse<Boolean>> HasScheduleAsync(Int32 programId, DateTime date)
    {
        return new(false);
    }
    ...
    async public Task<ApiResponse<List<FavoriteResponse>>> GetFavoritesAsync(Int32 userId)
    {
        ...
        [
            new (0, "Первый канал", "https://avatars.mds.yandex.net/i?id=979d579b84f454ca9abbb856d45ad7363ebc506a-16874457-images-thumbs&n=13"),
            new (1, "Россия-1", "https://static.wikia.nocookie.net/tvpedia/images/9/90/%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D1%8F-1_2012_%28%D0%B7%D0%B5%D1%80%D0%BA%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9%29.png/revision/latest?cb=20220318095737&path-prefix=ru"),
            new (2, "Матч ТВ", "https://avatars.mds.yandex.net/i?id=b57ed05890974b83fa552e92de99733b777eedc7-16288467-images-thumbs&n=13"),
            new (3, "НТВ", "https://avatars.mds.yandex.net/i?id=da9beacdb9b1656560f65509194c7288bb0c362f-4777526-images-thumbs&n=13"),
            new (4, "Пятый канал", "https://avatars.mds.yandex.net/i?id=fd8820f7d26c1ddc0d5d435acd934ac181bb7037-16330514-images-thumbs&n=13")];
    ...
    async public Task<ApiResponse<Int32>> AddUserAsync(String login, String password)
    {
        return new(await Task.FromResult(0));
    }
